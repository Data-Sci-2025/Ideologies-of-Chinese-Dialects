...
In this file, I updated some code based on the previous one in Progress Report 2. Then I added a new chunk.
...
**the following code runs, but it does not work--I still am not logged in.**
```{r}
#| eval: false
